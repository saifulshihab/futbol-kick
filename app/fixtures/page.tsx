...
export const metadata: Metadata = {
  title: "FIFA World Cup 2026 Fixtures & Match Schedule",
  description:
    "Complete FIFA World Cup 2026 match schedule — all group-stage fixtures with dates, kick-off times, venues, live scores, and results. Filter by group, team, or stage.",
  keywords: [
    ...
    "football fixtures 2026",
    "soccer schedule 2026",
    "World Cup 2026 live scores"
  ],
  alternates: {
    canonical: `${WEBSITE_BASE_URL}/fixtures`
  },
  openGraph: {
    title: "FIFA World Cup 2026 Fixtures & Match Schedule",
    description:
      "All group-stage matches — upcoming fixtures, live scores, and results for FIFA World Cup 2026. Filter by group, team, or stage.",
  ...
  twitter: {
    ...
    title: "FIFA World Cup 2026 Fixtures & Match Schedule",
    description:
      "All group-stage matches — upcoming fixtures, live scores, and results for FIFA World Cup 2026."
  }
};
...
const fixturesLd = {
  ...
  itemListElement: fixtures.map((f, i) => {
    ...
    return {
      ...
      item: {
        "@type": "SportsEvent",
        name: `${home?.name ?? f.homeTeamId} vs ${away?.name ?? f.awayTeamId}`,
        ...
        competitor: [
          { "@type": "SportsTeam", name: home?.name ?? f.homeTeamId },
          { "@type": "SportsTeam", name: away?.name ?? f.awayTeamId }
        ],
        ...(f.status === "completed" && f.homeScore !== undefined
          ? {
              description: `Final score: ${home?.code} ${f.homeScore}–${f.awayScore} ${away?.code}`
            }
          : {})
      }
    };
...
const breadcrumbLd = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: WEBSITE_BASE_URL },
    {
      ...
      position: 2,
      name: "Fixtures",
      item: `${WEBSITE_BASE_URL}/fixtures`
    }
  ]
};
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-brand-muted mt-2 text-sm">
            All {fixtures.length} group-stage matches · Filter by group, stage,
            or team
          </p>
        </div>
